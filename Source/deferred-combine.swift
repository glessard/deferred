...
public func reduce<T, U>(deferreds: [Deferred<T>], initial: U, combine: (U,T) throws -> U) -> Deferred<U>
{
...
public func reduce<S: SequenceType, T, U where
                   S.Generator.Element == Deferred<T>>(deferreds: S, initial: U, combine: (U,T) throws -> U) -> Deferred<U>
{
